  ...
  return (
    <AppShell>
      <div className="grid gap-5 xl:grid-cols-[1fr_1fr]">
        <Card>
          <h2 className="text-lg font-semibold tracking-tight">{t.teacher.preparationCards}</h2>
        ...
        <Card>
          <h2 className="text-lg font-semibold tracking-tight">{t.teacher.validation}</h2>
