    ...
    <AppShell>
      <div className="grid gap-5 xl:grid-cols-[1fr_1fr]">
        ...
        <Card>
          ...
          <p className="mt-3 text-black/60 dark:text-white/60">{t.teacher.validationText}</p>
          <div className="mt-5 rounded-lg bg-amber-50 p-4 font-semibold text-amber-900 dark:bg-amber-300/15 dark:text-amber-200">{t.teacher.warning}</div>
        </Card>
      </div>
    </AppShell>
  );
